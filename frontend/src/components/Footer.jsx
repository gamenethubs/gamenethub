...
//             <div>
//               <div style={styles.brandTitle}>Gamenethub</div>
//               <div style={styles.brandSubtitle}>Play browser games, rate & enjoy.</div>
//             </div>
//           </div>

//           <div style={styles.copy}>© {year} Gamenethub. All rights reserved.</div>
//         </div>
...
// import React from "react";
// import { Link } from "react-router-dom";
// import Logo from "../assets/Gamenethub.png"; // ⭐ ADDED
...
//         <div style={styles.brandCol}>
//           <div style={styles.brandRow}>
//             {/* ⭐ REPLACED EMOJI WITH IMAGE LOGO */}
//             <img
//               src={Logo}
//               alt="Gamenethub logo"
//               style={{
...
export default function Footer() {
 ...
 // ⭐ SUBSCRIBE HANDLER (Local + Render both)
const handleSubscribe = async (e) => {
  ...
  try {
    await axios.post(`${API_BASE}/api/subscribe`, { email });
      ...
      <div style={styles.container}>
        ...
        <div style={styles.actionsCol}>
          ...
          <div style={styles.socialRow}>
            ...
            <IconCircle>
              <a
                href="https://x.com/gamenethub"
                target="_blank"
                rel="noreferrer"
              >
                <svg width="16" height="16" fill="#9fd0ff" viewBox="0 0 24 24">
                  <path d="M22 4.01c-.77.35-1.6.59-2.47.69a4.26 4.26 0 0 0-7.27 3v.44A12.08 12.08 0 0 1 3.15 3.16a4.23 4.23 0 0 0-.58 2.15c0 1.5.76 2.82 1.92 3.6a4.21 4.21 0 0 1-1.92-.54v.05c0 2.08 1.48 3.82 3.45 4.22a4.25 4.25 0 0 1-1.9.07c.54 1.67 2.08 2.88 3.92 2.91A8.5 8.5 0 0 1 2 19.54a12 12 0 0 0 6.5 1.9c7.79 0 12.06-6.45 12.06-12.05v-.55A8.72 8.72 0 0 0 22 4.01z" />
                </svg>
              </a>
            </IconCircle>
            ...
            <IconCircle>
              <a
                href="https://www.instagram.com/gamenethubs/"
                target="_blank"
                rel="noreferrer"
              >
                <svg width="16" height="16" fill="#9fd0ff" viewBox="0 0 24 24">
                  <path d="M7 2C4.2 2 2 4.2 2 7v10c0 2.8 2.2 5 5 5h10c2.8 0 5-2.2 5-5V7c0-2.8-2.2-5-5-5H7zm5 5a5 5 0 110 10 5 5 0 010-10zm6-1.2a1.2 1.2 0 11-2.4 0 1.2 1.2 0 012.4 0z" />
                </svg>
              </a>
            </IconCircle>
            ...
            <IconCircle>
              <a
                href="https://www.facebook.com/profile.php?id=61583856364121"
                target="_blank"
                rel="noreferrer"
              >
                <svg width="16" height="16" fill="#9fd0ff" viewBox="0 0 24 24">
                  <path d="M22 12a10 10 0 10-11.5 9.9v-7H8v-3h2.5V9.5c0-2.5 1.5-3.9 3.7-3.9 1.1 0 2.2.2 2.2.2v2.5h-1.2c-1.2 0-1.6.8-1.6 1.6V12H18l-.5 3h-2v7A10 10 0 0022 12z" />
                </svg>
              </a>
            </IconCircle>
