...
function App() {
   ...
   * (now handled inside SocketContext globally)
   ********************************************/
  // 🔥 Keeping comments EXACTLY as-is (requested)
  //   React.useEffect(() => {
  ...
  return (
    // ⭐ Entire App wrapped inside SocketProvider
    <SocketProvider>
      <div style={styles.appWrapper}>
        ...
        {showTrain && <Train onFinish={() => setShowTrain(false)} />}
