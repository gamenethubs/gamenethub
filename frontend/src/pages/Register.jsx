...
//         <p style={styles.sub}>Join Gamenethub — free & instant play</p>
...
import { useNavigate } from "react-router-dom";
import { registerUser } from "../services/api";
import Logo from "../assets/Gamenethub.png"; // ⭐ ADDED IMPORT
...
export default function Register() {
  ...
  return (
    <div style={styles.wrapper}>
      ...
      >
        {/* ⭐ REPLACED EMOJI WITH FULLY FITTING LOGO */}
